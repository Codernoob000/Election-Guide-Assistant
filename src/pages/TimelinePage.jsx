    ...
    <main className="timeline-page" id="main-content">
      ...
      <div className="timeline">
        {TIMELINE_STAGES.map((stage, index) => (
          <div
            key={stage.id}
            className={`timeline__item ${expanded[stage.id] ? 'expanded' : ''}`}
          >
            <div className="timeline__connector">
              ...
              {index < TIMELINE_STAGES.length - 1 && (
                <div className="timeline__line" style={{ background: `linear-gradient(${stage.color}, ${TIMELINE_STAGES[index + 1].color})` }} />
              )}
            </div>
            ...
            <div className="timeline__card">
              <div className="timeline__card-header">
                <div>
                  ...
                  <h3 className="timeline__card-title">
                    {t(`timeline.stages.${stage.id}.title`)}
                  </h3>
              ...
              <p className="timeline__card-desc">
                {t(`timeline.stages.${stage.id}.description`)}
              </p>
              {expanded[stage.id] && (
